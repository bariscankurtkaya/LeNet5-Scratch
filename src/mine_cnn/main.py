...
conv_kernel1 = np.random.randn(6,1,5,5) - 0.5
conv_bias1 = np.random.randn(6, 1)

conv_kernel2 = np.random.randn(16,6,5,5) - 0.5
conv_bias2 = np.random.randn(16, 1)

fc_weight1 = (np.random.randn(120, 400) - 0.5) * np.sqrt(1./400)
fc_bias1 = np.random.randn(120, 1)

fc_weight2 = (np.random.randn(84, 120) - 0.5) * np.sqrt(1./120)
fc_bias2 = np.random.randn(84, 1)

fc_weight3 = (np.random.randn(10, 84) - 0.5) * np.sqrt(1./84)
